...
//cache.get(4);       // 返回  4
// 
// Related Topics 设计 哈希表 链表 双向链表 👍 125 👎 0
 ...
 * create: 2021-10-19 20:54:29
 */
public class Q面试题1625_LruCacheLcci {
    public static void main(String[] args) {
        LRUCache solution = new Q面试题1625_LruCacheLcci().new LRUCache(5);
    }
