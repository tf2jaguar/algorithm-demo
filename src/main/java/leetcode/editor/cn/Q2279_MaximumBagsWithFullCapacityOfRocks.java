 ...
 * create: 2022-07-05 11:26:39
 */
public class Q2279_MaximumBagsWithFullCapacityOfRocks {
    public static void main(String[] args) {
        Solution solution = new Q2279_MaximumBagsWithFullCapacityOfRocks().new Solution();
        int[] capacity = new int[]{10, 2, 2}, rocks = {2, 2, 0};
        int additionalRocks = 100;
        int bags = solution.maximumBags(capacity, rocks, additionalRocks);
