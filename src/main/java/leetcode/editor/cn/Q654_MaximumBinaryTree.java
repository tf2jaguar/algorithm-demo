...
// 
//
// Related Topics 栈 树 数组 分治 二叉树 单调栈 👍 572 👎 0
...
/**
 * title: 654 : 最大二叉树
 * create: 2022-10-08 10:43:53
 */
public class Q654_MaximumBinaryTree {
    public static void main(String[] args) {
        Solution solution = new Q654_MaximumBinaryTree().new Solution();
    ...
    class Solution {
        public TreeNode constructMaximumBinaryTree(int[] nums) {
            ...
            int[] left = splitArray(nums, 0, maxIdx);
            int[] right = splitArray(nums, maxIdx + 1, nums.length);
